        ...
        <div className='xl:mx-20 mx-4'>
            <ScrollTrigger onEnter={() => setCounter(true)} onExit={() => setCounter(false)}>
                <div className='grid lg:grid-cols-4 grid-cols-2 gap-5 '>
                    <div className="flex items-center lg:space-x-4 space-x-2 transition-transform transform hover:translate-y-[-4px]">
                        ...
                        <div className=''>
                        <span className='text-[#94a3b8] md:text-lg text-sm'>
                            <p className='md:text-2xl text-lg font-bold text-black font-heading'>
